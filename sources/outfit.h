...
struct Outfit
{
	Outfit()
	{
		...
		healthGain = healthTicks = manaGain = manaTicks = conditionSuppressions = principalSkill = 0;
	}
	...
	int32_t skills[SKILL_LAST + 1], skillsPercent[SKILL_LAST + 1], stats[STAT_LAST + 1], statsPercent[STAT_LAST + 1],
		speed, attackSpeed, healthGain, healthTicks, manaGain, manaTicks, conditionSuppressions, principalSkill;
