local decay = {6300, 6301}  --id dos item que eh pra dar decay caso o player mova ele do depot

--pode jogar essa função na LIB
...
function onThrow(cid, item, fromPosition, toPosition)
    if fromPosition.y >= 64 then		-- vindo do depot
